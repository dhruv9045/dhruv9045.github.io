...
<?php include("upper_button.php");	?>
	...
	<nav id="sidebar-wrapper">
	    ...
	    <ul class="sidebar-nav">
			...
			<li><a href="#Updated_events">Event</a></li>
			<li><a href="#Comming_soon">Comming_soon</a></li>		
					...
					<div class="headings">
						...
						<div class="row">
							<div class="col-xs-6 col-sm-6 col-md-5">
								<div>
									<a href="#gallery" class="polo-btn store wow animated bounceInUp"><i class=""></i> Check Us</a>
								</div>
							</div>
							<div class="col-xs-6 col-sm-6 col-md-5">
								<div>
...
<section id="Updated_events" class="block">	
<section class="container">
			<section class="row">
	...
	<div class="container">
	<!-- 	<div class="scrolling-box">     -->  <!-- scroll box -->
  <div class="card-media card_1">
    <!-- media container -->
  ...
  <div class="card-media card_2">
    <!-- media container -->
    <div class="card-media-object-container">
      <div class="card-media-object" style="background-image: url(https://s16.postimg.cc/x8m99xtgl/tyco_f.jpg);"></div>
      <ul class="card-media-object-social-list">
        <li>
...
<section id="Comming_soon" class="block">	
<section class="container">
			<section class="row">
				<div class="title-box"><h1 class="block-title wow animated rollIn">
				<span class="bb-top-left"></span>
  ...
  <div class="card-media card_3">
    <!-- media container -->
    <div class="card-media-object-container">
      <div class="card-media-object" style="background-image: url(https://s9.postimg.cc/y0sfm95gv/prince_f.jpg);"></div>
      <span class="card-media-object-tag subtle">comming soon</span>
      <ul class="card-media-object-social-list">
        <li>
          <img src="https://s10.postimg.cc/3rjjbzcvd/profile_f.jpg" class="">
        </li>
    ...
    <div class="card-media-body">
      ...
      <div class="card-media-body-supporting-bottom card-media-body-supporting-bottom-reveal">
        <span class="card-media-body-supporting-bottom-text subtle">#IRC</span>
        <a href="#/" class="card-media-body-supporting-bottom-text card-media-link u-float-right">VIEW TICKETS</a>
      </div>
    </div>
  </div>
  
  <div class="card-media card_4">
  <!-- media container -->
    <div class="card-media-object-container">
      <div class="card-media-object" style="background-image: url(https://s9.postimg.cc/y0sfm95gv/prince_f.jpg);"></div>
      <span class="card-media-object-tag subtle">comming soon</span>
    ...
    <div class="card-media-body">
      ...
      <div class="card-media-body-supporting-bottom card-media-body-supporting-bottom-reveal">
        <span class="card-media-body-supporting-bottom-text subtle">#Manouver</span>
        <a href="#/" class="card-media-body-supporting-bottom-text card-media-link u-float-right">VIEW TICKETS</a>
      </div>
    </div>
  </div>
